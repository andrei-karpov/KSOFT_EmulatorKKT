...
Функция СформироватьЧек(ИДУстройства, Электронно, ДанныеЧека, ВыходныеПараметрыДокумента) Экспорт 
	...
	РезультатОперации = ЭмуляторKSOFT_ФормированиеЧека.СформироватьИОтправитьЧек(ДанныеЧека, ПараметрыДокумента, ПараметрыЧекаДляВывода, Электронно);
...
Функция СформироватьЧекКоррекции(ИДУстройства, ДанныеЧека, ВыходныеПараметрыДокумента) Экспорт
	...
	РезультатОперации = ЭмуляторKSOFT_ФормированиеЧека.СформироватьИОтправитьЧек(ДанныеЧека, ПараметрыДокумента, ПараметрыЧекаДляВывода, Ложь, Истина);
...
Функция ВыполнитьДополнительноеДействие(пИмяДействия) Экспорт
	...
	ИначеЕсли Врег(пИмяДействия) = "OPENSHIFT" Тогда
		ОткрытьСмену(0, Неопределено, Неопределено);
		Возврат Истина;
	ИначеЕсли Врег(пИмяДействия) = "CLOSESHIFT" Тогда 	
		ЗакрытьСмену(0, Неопределено, Неопределено);
		Возврат Истина;
	КонецЕсли; 
