...
Функция ОписаниеДрайвераСтруктура() Экспорт 
	...
	ПараметрыОписанияДрайвера.Вставить("Name", "K-SOFT: Эмулятор контрольно-кассовой техники нового образца c функций эквайринговых операций");
	ПараметрыОписанияДрайвера.Вставить("Description", "K-SOFT: Эмулятор контрольно-кассовой техники нового образца c функций эквайринговых операций для подключения к ""1С:Предприятие""");
...
Функция ОбъектДрайвераЭмулятор(ДанныеОборудования) Экспорт
	...
	Если ДанныеОборудования.Свойство("Параметры") Тогда
